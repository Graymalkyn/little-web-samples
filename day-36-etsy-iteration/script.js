...
//Show me how to calculate the average price of all items. Please console.log the average.  I'll accept either $23.63 or $23.62.
function averagePriceOfAllItems(){
  var total = 0;
  for (var item of items) {
    var itemPrice = item.price;
    var totalPrice = total += itemPrice;
    var itemCount = items.length;
  }
  var averagePrice = totalPrice / itemCount;
  return Math.round(averagePrice * 100) / 100;
}
var averagePrice = averagePriceOfAllItems();
